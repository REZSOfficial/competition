    ...
    <form method="POST" action="/competitions">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="sport" type="text" class="form-control" id="sport" aria-describedby="sportHelp" placeholder="Sport" value="{{old('sport')}}">
            @error('sport')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="form-group">
            ...
            <input name="prize" type="number" class="form-control" id="prize" aria-describedby="prizeHelp" max="999999999" placeholder="Prize ($)" value="{{old('prize')}}">
            @error('prize')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
          </div>
